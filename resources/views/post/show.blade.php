...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">• {{ $date->translatedFormat('M') }} {{ $date->format('d') }}, {{ $date->format('Y') }} •
                    ...
                    <section class="related-posts">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                <img src="{{ asset('storage/' . $relatedPost->preview_image) }}" alt="related post" class="post-thumbnail" style="height: 300px">
